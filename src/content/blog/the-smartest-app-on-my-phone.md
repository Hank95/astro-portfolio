...
If my theory about the architecture is right — and the "18 hours of content" number strongly suggests it — the app pre-downloads the segment library to your device and assembles classes locally. That would explain why Down Dog works perfectly on airplane mode. There's no server call needed to generate a class; the sequencing logic and all the content live on your phone.
...
That last part is the hardest. The difference between "technically correct sequence of yoga poses" and "this feels like a great class" is enormous, and it requires deep domain expertise in yoga instruction — which is exactly what Simon brought from his teacher training.
